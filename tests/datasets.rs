...
fn roygbiv_hex_values_are_consistent() {
    assert_eq!(ROYGBIV::Red.rgb(), 0x00ff_0000);
    assert_eq!(ROYGBIV::Indigo.rgb(), 0x004b_0082);
    assert_eq!(ROYGBIV::Violet.rgb(), 0x0094_00d3);
}

#[test]
fn css_colors_match_documented_hex_codes() {
    assert_eq!(CSS::Tomato.rgb(), 0x00ff_6347);
    assert_eq!(CSS::RebeccaPurple.rgb(), 0x0066_3399);
    assert_eq!(CSS::DarkSlateGrey.rgb(), 0x002f_4f4f);
}
