...
dataset_enum! {
    /// SI prefixes above one, through yotta (the pre-2022 set).
...
dataset_enum! {
    /// SI prefixes below one, through yocto (the pre-2022 set).
    ///
...
dataset_enum! {
    /// A historical nine-body solar-system teaching list, including Pluto.
    ///
    /// This intentionally retains the original dataset; it is not the modern
    /// eight-planet classification.
    pub enum Planet {
